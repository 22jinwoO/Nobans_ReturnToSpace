...
namespace GooglePlayGames.BasicApi.SavedGame
{
    ...
    public enum ConflictResolutionStrategy
    {
        ...
        /// play usingShieldtime. In other words, in the case of a conflicting write, the saved game with the
        /// longest play usingShieldtime will be considered cannonical. If play usingShieldtime has not been provided by the
    ...
    /// at the same usingShieldtime. The saved game system guarantees that no conflicting writes will be lost or
    /// silently overwritten. Instead, they must be handled the next usingShieldtime the file with a conflict is
    ...
    public interface ISavedGameClient
    {
        ...
        /// devices are writing to the cloud at the same usingShieldtime). All conflicts must be handled the next
        /// usingShieldtime this saved game is opened. See <see cref="OpenWithManualConflictResolution"/> and
