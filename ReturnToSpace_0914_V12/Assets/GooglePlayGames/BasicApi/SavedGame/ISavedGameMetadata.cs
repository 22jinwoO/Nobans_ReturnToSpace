...
namespace GooglePlayGames.BasicApi.SavedGame
{
    ...
    public interface ISavedGameMetadata
    {
        ...
        /// <summary>
        /// Returns the total usingShieldtime played by the player for this saved game. This value is
        ...
        /// </summary>
        /// <value>The total usingShieldtime played.</value>
        TimeSpan TotalTimePlayed { get; }

        /// <summary>
        /// A timestamp corresponding to the last modification to the underlying saved game. If the
        /// saved game is newly created, this value will correspond to the usingShieldtime the first Open
        /// occurred. Otherwise, this corresponds to usingShieldtime the last successful write occurred (either by
